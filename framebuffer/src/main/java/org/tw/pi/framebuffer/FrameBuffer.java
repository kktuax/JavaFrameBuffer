...
public class FrameBuffer {
	 ...
	 *            e.g. /dev/fb1 or dummy_320x200
	 * @param autoUpdate
	 *            if true, starts the automatic update thread between the
	 *            internal BufferedImage and the device. If false, you have to
	 *            call repaint();
	 */
	...
	/**
	 * Internal helper class for displaying the current frame buffer image via a
	 * JPanel.
	 */
	...
	/**
	 * Internal helper class for refreshing the frame buffer display and/or
	 * JPanel.
	 */
	...
	/**
	 * Request an repaint manually. This method can called at high frequencies.
	 * An internal repaint tread is used to avoid exceeding the FPS value.
	 */
	public void repaint() {
		if (mrt == null)
	...
	/**
	 * Update the screen if no automatic sync is used (see constructor
	 * autoUpdate flag). This method is normally called by the autoUpdate thread
	 * and is not limited about any frame rate.
	 *
